...
Список (list) - упорядоченная изменяемая коллекция элементов различных типов. Почти как массивы, но вообще ни разу не массивы. Элементы в списке могут быть различны типов и менять состав элементов списка можно когда угодно и как угодно (в отличии от массивов).
